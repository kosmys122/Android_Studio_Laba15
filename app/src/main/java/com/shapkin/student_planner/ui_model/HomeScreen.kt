package com.shapkin.student_planner.ui_model
...
import com.shapkin.student_planner.data.Subject
import com.shapkin.student_planner.data.samleSubjects
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Преподователь: ${subject.professor}",
